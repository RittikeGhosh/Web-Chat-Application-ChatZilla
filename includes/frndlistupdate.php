...
if(isset($_POST['status']) && isset($_POST['fid']) && !empty($_POST['fid']) && $_POST['status']< 4)
{
    ...
    elseif ($frndstatus == 2)
    {
	    ...
	    $uquery = "CREATE TABLE $umsgtable(message varchar(300) NOT NULL,dandti datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,status integer(2));"  ;   //query for the user

	    $fquery = "CREATE TABLE $fmsgtable(message varchar(300) NOT NULL,dandti datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,status integer(2));" ;        //query for the user friend
